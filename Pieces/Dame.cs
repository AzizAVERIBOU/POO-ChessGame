...
namespace echec_poo.Pieces
{
    ...
    /// Règles : Combine les mouvements de la tour et du fou
    /// Se déplace horizontalement, verticalement et en diagonale
    /// </summary>
    public class Dame : Piece
    {
        public Dame(Couleur couleur, Position position) : base(couleur, position)
        {
        }
        ...
        public override bool PeutSeDeplacerVers(Position nouvellePosition, Echiquier echiquier)
        {
            ...
            // Vérifier que c'est un mouvement horizontal, vertical ou diagonal
            bool mouvementHorizontal = deltaLigne == 0 && deltaColonne != 0;
            bool mouvementVertical = deltaLigne != 0 && deltaColonne == 0;
            bool mouvementDiagonal = Math.Abs(deltaLigne) == Math.Abs(deltaColonne);

            if (!mouvementHorizontal && !mouvementVertical && !mouvementDiagonal)
                return false;
        ...
        public override List<Position> ObtenirMouvementsPossibles(Echiquier echiquier)
        {
            ...
            // Toutes les directions : horizontal, vertical et diagonal
            int[,] directions = { 
        ...
        {
            return Couleur == Couleur.Blanc ? "D" : "d";
        }
